...
class FeatureIndex {
 public:
  ...
  static bool convert(const Param& param, const char* text_filename, std::string* output);
  static bool compile(const Param& param, const char* text_filename, const char* binary_filename);
...
class EncoderFeatureIndex : public FeatureIndex {
 public:
  ...
  bool reopen(const char* filename, const char* charset, std::vector<double>* alpha, Param* param);
