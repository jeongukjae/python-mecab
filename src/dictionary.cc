...
bool Dictionary::assignUserDictionaryCosts(const Param& param,
...
bool Dictionary::compile(const Param& param, const std::vector<std::string>& dics, const char* output) {
  Connector matrix;
